...
<div align="center"> <img src="./photo/B+树.jpg" width="600"/> </div><br>
...
<div align="center"> <img src="./photo/索引1.png" width="600"/> </div><br>
辅助索引的叶子节点的data域记录着主键的值，因此在使用辅助索引进行查找时，需要先查找到主键值，然后再到主索引中进行查找。
<div align="center"> <img src="./photo/索引2.jpg" width="600"/> </div><br>
（2）哈希索引
